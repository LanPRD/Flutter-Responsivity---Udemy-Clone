...
class AdvantagesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildVertialAdvantages(String title, String subtitle) {
      return Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Icon(Icons.star, color: Colors.white, size: 50),
    ...
    return LayoutBuilder(
      builder: (_, constaints) {
        if (constaints.maxWidth >= mobileBreakpoint) {
          return Container(
            ...
            child: Wrap(
              ...
              spacing: 12,
              children: [
                buildHorizontalAdvantages("+45.000 alunos", "Didática garantida"),
                buildHorizontalAdvantages("+45.000 alunos", "Didática garantida"),
                buildHorizontalAdvantages("+45.000 alunos", "Didática garantida"),
              ],
            ),
        ...
        return Container(
          ...
          child: Wrap(
            ...
            spacing: 12,
            children: [
              buildVertialAdvantages("+45.000 alunos", "Didática garantida"),
              buildVertialAdvantages("+45.000 alunos", "Didática garantida"),
              buildVertialAdvantages("+45.000 alunos", "Didática garantida"),
            ],
          ),
